...
export default function Accont_Pannel_meno() {
  ...
  const [item_meno, set_item_meno] = useState([
    ...
    {
      porofile_translate: "لیست علاقه‌مندی‌ها",
      porofile: "Wish list",
      img: "/svgs/heart.svg",
      class: "text-gray-700 hover:text-blue-500 cursor-pointer ",
    ...
    {
      porofile_translate: "امنیت و دسترسی",
    ...
    {
      porofile_translate: "خروج از حساب",
      porofile: "Log out",
      img: "/svgs/logout.svg",
      class: "text-red-600",
